...
import { ArrowLeft, Save, X, Plus, Trash2, Loader2, Upload, Link as LinkIcon, Image as ImageIcon } from "lucide-react";
...
export default function CreateTourPage() {
  ...
  const createMutation = useMutation({
    ...
    onError: (error: any) => {
      showError(error.message || "Có lỗi xảy ra khi tạo tour");
        ...
        <div className="space-y-4">
          ...
          <div>
            ...
            <p className="text-xs text-gray-500 dark:text-gray-400 mt-1">
              Số chỗ trống sẽ tự động bằng số chỗ tối đa khi tạo tour
            </p>
          </div>
        </div>
