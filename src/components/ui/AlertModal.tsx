...
export const AlertModal: React.FC<AlertModalProps> = ({
  ...
  const getIconColor = () => {
    switch (type) {
      ...
      case "error":
        return "fill-error-50 dark:fill-error-500/15";
      case "warning":
        return "fill-warning-50 dark:fill-warning-500/15";
      case "info":
        return "fill-blue-light-50 dark:fill-blue-light-500/15";
      default:
        return "fill-blue-light-50 dark:fill-blue-light-500/15";
    }
  };

  const getIconInnerColor = () => {
    switch (type) {
      case "success":
        return "fill-success-600 dark:fill-success-500";
      case "error":
        return "fill-error-600 dark:fill-error-500";
      case "warning":
        return "fill-warning-600 dark:fill-orange-400";
      case "info":
        return "fill-blue-light-500 dark:fill-blue-light-500";
      default:
        return "fill-blue-light-500 dark:fill-blue-light-500";
    }
  };
      ...
      <div className="text-center">
        ...
        <div className="flex items-center justify-center w-full gap-3 mt-7">
          <button
            ...
            className={`flex justify-center w-full px-4 py-3 text-sm font-medium text-white rounded-lg shadow-theme-xs sm:w-auto ${getButtonColor()}`}
          >
            {confirmText}
          </button>
        </div>
